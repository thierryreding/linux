...
enum pin_id {
	...
	TEGRA_PIN_CAN2_DOUT_PS0,
	TEGRA_PIN_CAN2_DIN_PS1,
	TEGRA_PIN_CAN2_STB_PS2,
	TEGRA_PIN_CAN2_EN_PS3,
	TEGRA_PIN_CAN2_ERR_PS4,
	TEGRA_PIN_CAN3_DOUT_PS5,
	TEGRA_PIN_CAN3_DIN_PS6,
	TEGRA_PIN_CAN3_STB_PS7,
	TEGRA_PIN_CAN3_EN_PT0,
	TEGRA_PIN_CAN3_ERR_PT1,
	TEGRA_PIN_SOC_ERROR_PU0,
	TEGRA_PIN_UART7_TX_PU1,
	TEGRA_PIN_UART7_RX_PU2,
	TEGRA_PIN_SPI7_SCK_PU3,
	TEGRA_PIN_SPI7_MISO_PU4,
	TEGRA_PIN_SPI7_MOSI_PU5,
	TEGRA_PIN_SPI7_CS0_PU6,
	TEGRA_PIN_SOC_GPIO51_PU7,
	TEGRA_PIN_SOC_GPIO52_PV0,
	TEGRA_PIN_SOC_GPIO61_PW0,
	TEGRA_PIN_SOC_GPIO62_PW1,
...
static const struct pinctrl_pin_desc tegra234_pins[] = {
	...
	PINCTRL_PIN(TEGRA_PIN_CAN2_DOUT_PS0, "CAN2_DOUT_PS0"),
	PINCTRL_PIN(TEGRA_PIN_CAN2_DIN_PS1, "CAN2_DIN_PS1"),
	PINCTRL_PIN(TEGRA_PIN_CAN2_STB_PS2, "CAN2_STB_PS2"),
	PINCTRL_PIN(TEGRA_PIN_CAN2_EN_PS3, "CAN2_EN_PS3"),
	PINCTRL_PIN(TEGRA_PIN_CAN2_ERR_PS4, "CAN2_ERR_PS4"),
	PINCTRL_PIN(TEGRA_PIN_CAN3_DOUT_PS5, "CAN3_DOUT_PS5"),
	PINCTRL_PIN(TEGRA_PIN_CAN3_DIN_PS6, "CAN3_DIN_PS6"),
	PINCTRL_PIN(TEGRA_PIN_CAN3_STB_PS7, "CAN3_STB_PS7"),
	PINCTRL_PIN(TEGRA_PIN_CAN3_EN_PT0, "CAN3_EN_PT0"),
	PINCTRL_PIN(TEGRA_PIN_CAN3_ERR_PT1, "CAN3_ERR_PT1"),
	PINCTRL_PIN(TEGRA_PIN_SOC_ERROR_PU0, "SOC_ERROR_PU0"),
	PINCTRL_PIN(TEGRA_PIN_UART7_TX_PU1, "UART7_TX_PU1"),
	PINCTRL_PIN(TEGRA_PIN_UART7_RX_PU2, "UART7_RX_PU2"),
	PINCTRL_PIN(TEGRA_PIN_SPI7_SCK_PU3, "SPI7_SCK_PU3"),
	PINCTRL_PIN(TEGRA_PIN_SPI7_MISO_PU4, "SPI7_MISO_PU4"),
	PINCTRL_PIN(TEGRA_PIN_SPI7_MOSI_PU5, "SPI7_MOSI_PU5"),
	PINCTRL_PIN(TEGRA_PIN_SPI7_CS0_PU6, "SPI7_CS0_PU6"),
	PINCTRL_PIN(TEGRA_PIN_SOC_GPIO51_PU7, "SOC_GPIO51_PU7"),
	PINCTRL_PIN(TEGRA_PIN_SOC_GPIO52_PV0, "SOC_GPIO52_PV0"),
	PINCTRL_PIN(TEGRA_PIN_SOC_GPIO61_PW0, "SOC_GPIO61_PW0"),
	PINCTRL_PIN(TEGRA_PIN_SOC_GPIO62_PW1, "SOC_GPIO62_PW1"),
...
static const unsigned int can2_dout_ps0_pins[] = {
	TEGRA_PIN_CAN2_DOUT_PS0,
};
static const unsigned int can2_din_ps1_pins[] = {
	TEGRA_PIN_CAN2_DIN_PS1,
};
static const unsigned int can2_stb_ps2_pins[] = {
	TEGRA_PIN_CAN2_STB_PS2,
};
static const unsigned int can2_en_ps3_pins[] = {
	TEGRA_PIN_CAN2_EN_PS3,
};
static const unsigned int can2_err_ps4_pins[] = {
	TEGRA_PIN_CAN2_ERR_PS4,
};
static const unsigned int can3_dout_ps5_pins[] = {
	TEGRA_PIN_CAN3_DOUT_PS5,
};
static const unsigned int can3_din_ps6_pins[] = {
	TEGRA_PIN_CAN3_DIN_PS6,
};
static const unsigned int can3_stb_ps7_pins[] = {
	TEGRA_PIN_CAN3_STB_PS7,
};
static const unsigned int can3_en_pt0_pins[] = {
	TEGRA_PIN_CAN3_EN_PT0,
};
static const unsigned int can3_err_pt1_pins[] = {
	TEGRA_PIN_CAN3_ERR_PT1,
};
static const unsigned int soc_error_pu0_pins[] = {
	TEGRA_PIN_SOC_ERROR_PU0,
};
static const unsigned int uart7_tx_pu1_pins[] = {
	TEGRA_PIN_UART7_TX_PU1,
};
static const unsigned int uart7_rx_pu2_pins[] = {
	TEGRA_PIN_UART7_RX_PU2,
};
static const unsigned int spi7_sck_pu3_pins[] = {
	TEGRA_PIN_SPI7_SCK_PU3,
};
static const unsigned int spi7_miso_pu4_pins[] = {
	TEGRA_PIN_SPI7_MISO_PU4,
};
static const unsigned int spi7_mosi_pu5_pins[] = {
	TEGRA_PIN_SPI7_MOSI_PU5,
};
static const unsigned int spi7_cs0_pu6_pins[] = {
	TEGRA_PIN_SPI7_CS0_PU6,
};
static const unsigned int soc_gpio51_pu7_pins[] = {
	TEGRA_PIN_SOC_GPIO51_PU7,
};
static const unsigned int soc_gpio52_pv0_pins[] = {
	TEGRA_PIN_SOC_GPIO52_PV0,
};
static const unsigned int soc_gpio61_pw0_pins[] = {
	TEGRA_PIN_SOC_GPIO61_PW0,
};
static const unsigned int soc_gpio62_pw1_pins[] = {
	TEGRA_PIN_SOC_GPIO62_PW1,
};
