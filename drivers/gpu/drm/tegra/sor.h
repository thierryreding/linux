...
#define  SOR_DP_AUDIO_CTRL_NEW_SETTINGS		(1 << 31)
#define  SOR_DP_AUDIO_CTRL_MUTE_STATUS		(1 << 21)
#define  SOR_DP_AUDIO_CTRL_CA_SELECT		(1 << 20)
#define  SOR_DP_AUDIO_CTRL_SS_SELECT		(1 << 19)
#define  SOR_DP_AUDIO_CTRL_SF_SELECT		(1 << 18)
#define  SOR_DP_AUDIO_CTRL_CC_SELECT		(1 << 17)
#define  SOR_DP_AUDIO_CTRL_CT_SELECT		(1 << 16)
#define  SOR_DP_AUDIO_CTRL_ENABLE		(1 <<  0)
...
#define SOR_DP_OUTPUT_CHANNEL_STATUS2 0x13b
#define  SOR_DP_OUTPUT_CHANNEL_STATUS2_ENABLE (1 << 31)
