...
static const u8 tegra194_sor_voltage_swing[4][4][4] = {
	{
		{ 0x15, 0x1c, 0x23, 0x2d },
		{ 0x20, 0x27, 0x2f, },
		{ 0x2c, 0x36, },
...
static const u8 tegra194_sor_pre_emphasis[4][4][4] = {
	{
		{ 0x00, 0x0c, 0x1a, 0x2f },
		{ 0x00, 0x10, 0x22, },
		{ 0x01, 0x19, },
...
static const u8 tegra194_sor_post_cursor[4][4][4] = {
	{
		{ 0x00, 0x00, 0x00, 0x00 },
		{ 0x00, 0x00, 0x00, },
		{ 0x00, 0x00, },
...
static const u8 tegra194_sor_tx_pu[4][4][4] = {
	{
		{ 0x20, 0x30, 0x40, 0x60 },
		{ 0x30, 0x40, 0x60, },
		{ 0x40, 0x60, },
