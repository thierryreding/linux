...
#define TEGRA194_IO_PAD_TABLE(_pad) \
	...
	_pad(TEGRA_IO_PAD_PEX_CLK2_BIAS,  9,   UINT_MAX, "pex-clk2-bias"), \
	_pad(TEGRA_IO_PAD_PEX_CLK2,      10,   UINT_MAX, "pex-clk2"), \
	...
	_pad(TEGRA_IO_PAD_SOC_GPIO53,    16,   UINT_MAX, "gpio53"), \
	_pad(TEGRA_IO_PAD_AUDIO,         17,   UINT_MAX, "audio"), \
	_pad(TEGRA_IO_PAD_GP_PWM2,       18,   UINT_MAX, "pwm2"), \
	_pad(TEGRA_IO_PAD_GP_PWM3,       19,   UINT_MAX, "pwm3"), \
	_pad(TEGRA_IO_PAD_SOC_GPIO12,    20,   UINT_MAX, "gpio12"), \
	_pad(TEGRA_IO_PAD_SOC_GPIO13,    21,   UINT_MAX, "gpio13"), \
	_pad(TEGRA_IO_PAD_SOC_GPIO10,    22,   UINT_MAX, "gpio10"), \
	...
	_pad(TEGRA_IO_PAD_HDMI_DP0,      28,   UINT_MAX, "hdmi-dp1"), \
	_pad(TEGRA_IO_PAD_HDMI_DP1,      29,   UINT_MAX, "hdmi-dp0"), \
	_pad(TEGRA_IO_PAD_PEX_CNTRL,     32,   UINT_MAX, "pex-cntrl"), \
	_pad(TEGRA_IO_PAD_PEX_CTL2,      33,   UINT_MAX, "pex-ctl2"), \
	_pad(TEGRA_IO_PAD_PEX_L0_RST_N,  34,   UINT_MAX, "pex-l0-rst-n"), \
	_pad(TEGRA_IO_PAD_PEX_L1_RST_N,  35,   UINT_MAX, "pex-l1-rst-n"), \
	_pad(TEGRA_IO_PAD_SDMMC4,        36,   UINT_MAX, "sdmmc4"), \
	_pad(TEGRA_IO_PAD_PEX_L5_RST_N,  37,   UINT_MAX, "pex-l5-rst-n"), \
	_pad(TEGRA_IO_PAD_CSIC,          43,   UINT_MAX, "csic"), \
	_pad(TEGRA_IO_PAD_CSID,          44,   UINT_MAX, "csid"), \
	_pad(TEGRA_IO_PAD_CSIE,          45,   UINT_MAX, "csie"), \
	_pad(TEGRA_IO_PAD_CSIF,          46,   UINT_MAX, "csif"), \
	...
	_pad(TEGRA_IO_PAD_EDP,           53,   UINT_MAX, "edp"), \
	_pad(TEGRA_IO_PAD_SDMMC1_HV,     55,   UINT_MAX, "sdmmc1-hv"), \
	_pad(TEGRA_IO_PAD_SDMMC3_HV,     56,   UINT_MAX, "sdmmc3-hv"), \
	_pad(TEGRA_IO_PAD_CONN,          60,   UINT_MAX, "conn"), \
	_pad(TEGRA_IO_PAD_AUDIO_HV,      61,   UINT_MAX, "audio-hv")
